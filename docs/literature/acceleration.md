...
starting points, but their applicability has not yet been established. This
file is source-oriented: project-only theorem development and round history
belong in `docs/research_notes.md`, direction notes, and the research-round
archive.
