...
- Conditional on the open static target `||u_+||_(1,D) <= 21q^3/80`, proved
  ...
  `qk >= 17/200`. The scalar comparison has exact rational slack
  `3188243/640000000` at the transition.
...
1. Prove the local endpoint half-ratios for `d-h` (or another proof of the
   static `21/80` target).
2. Prove the exact signed half-retention convolution through `qk<17/200`.
