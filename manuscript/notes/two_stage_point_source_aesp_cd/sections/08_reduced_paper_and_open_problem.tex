...
\item One sharply stated arbitrary-graph reporter problem.
\end{enumerate}
...
\subsection{The remaining breakthrough target}
...
\cref{prob:two-stage-general-discovery} is sufficient for the complete
point-source PPR target.  The qualification in the problem is essential:
