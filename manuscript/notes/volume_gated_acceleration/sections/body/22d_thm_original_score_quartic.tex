...
solvency theorem: by itself it supplies no convergence, recovery-horizon,
semantic stopping, or work conclusion.  The separate total-energy argument
in \cref{thm:complete-gate-soft-horizon} does supply a soft terminal horizon
for the same recurrence without treating this score as a convergence
potential.
\end{theorem}
