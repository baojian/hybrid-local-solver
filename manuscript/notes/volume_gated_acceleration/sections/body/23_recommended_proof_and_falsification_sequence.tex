...
$\delta^2$ all-history proof for this recurrence and gate.  The next upper
task must instead prove a useful structural promised-class condition, justify
an additional initial reserve, or replace the observable by a stronger energy
account, with every correction scan and Schur query charged.  Do not promote
any finite trace to a convergence failure, work lower bound, or asymptotic
telescope.
