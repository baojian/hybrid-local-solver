...
| [`signed_spider_generalization`](signed_spider_generalization/) | iterative | proved-open | Prove log-free radial SOR, charge certified face tuning, and isolate scalar-local propagation limits. |
