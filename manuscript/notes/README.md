...
| [`signed_spider_generalization`](signed_spider_generalization/) | iterative | proved-open | Prove log-free radial SOR, realize charged certified face tuning, and isolate scalar-local propagation limits. |
