...
| `delayed_reflection_ladder` | Alpha-scaled exact rungs and delayed reflection debt | Exact tree, bounded-block, cycle, and thin-radial-core solvers meet or beat the product scale; compressed events in thick large cores remain open. |
