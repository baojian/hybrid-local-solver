...
including those whose true leaves are reached.
\end{abstract}
...
\statusproved & A certified closed pendant forest can be permanently
Schur-deflated in linear work without core fill.  This solves reached stars
in $O(\mathcal V)$ and, spliced with the radial wave, proves the accelerated
bound on every finite symmetric spider. \\
...
\begin{enumerate}[leftmargin=*]
 ...
 \item Extend the proved pendant Schur correction beyond radial spiders.
 Detect maximal closed pendant forests online, prove that each attachment
 diagonal is installed only once, and couple the reduced-core solver to the
 same charged-work ledger.
...
removes the earlier unreached-leaf condition.
