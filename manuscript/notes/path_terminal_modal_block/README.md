...
The proper-prefix chronology, the two entry profiles, and the terminal
projection/envelope regime are not proved. A deterministic NumPy screen reconstructs
