...
$qk<3/50$.  Full regime preservation in
\cref{lem:terminal-modal-regime} is \emph{open} only through the static
late-envelope target \eqref{eq:terminal-modal-static-target-assumed}.  The table in
