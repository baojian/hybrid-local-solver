...
exact algebra.  The position entry profile in
\cref{lem:terminal-modal-position-profile} is proved asymptotically; the
velocity profile in \cref{lem:terminal-modal-velocity-profile} is also
proved.  The directed terminal packet, nonpositive literal entry correction,
and folded velocity-kernel alias bound are also proved.
Only regime preservation in \cref{lem:terminal-modal-regime} is \emph{open}.
The table in
