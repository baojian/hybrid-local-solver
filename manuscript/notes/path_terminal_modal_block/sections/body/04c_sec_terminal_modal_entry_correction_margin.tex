...
At this stage the early nonlinear target is the correlated inequality
...
\eqref{eq:terminal-modal-short-early-convolution-open} remains
\textbf{OPEN}; the analogous claim through $17/200$ is false and is not
used.  The later correlated stopped ledger proves half-retention without
requiring this stronger separate inequality.
