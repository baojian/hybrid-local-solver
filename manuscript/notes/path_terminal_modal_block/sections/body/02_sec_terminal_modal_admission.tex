...
loss in this Green kernel.  The uniform signed position estimate is proved in
\cref{sec:terminal-modal-position-profile}; the velocity estimate remains
open.  Absolute-value summation discards the moving-frontier phase and does
not deliver the velocity constant.
...
The position sum is bounded in
\cref{sec:terminal-modal-position-profile}.  At velocity scale the
