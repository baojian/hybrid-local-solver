...
\end{equation}
so $K_n\ge0$ on shared coordinates is sufficient for the open chronology
...
assume the still-open projected chronology.  To prove them, use
...
The finite-$q$ sign is still open.  The remaining task is a uniform
finite-cutoff/base anti-cancellation bound (or an equivalent spatial cone) for
\eqref{eq:terminal-modal-correction-source-triplet}, sharp enough to preserve
some of the margin in
\eqref{eq:terminal-modal-leading-correction-sign} under $mq=1/16$.
...
$((1-q)/2)(X_4(2)+X_4(1))$; that damped-Pascal route remains open alongside
direct control of the signed source cancellation.  For completeness, exact elimination of
