...
loss in this Green kernel.  The uniform signed position and velocity estimates
are proved in
\cref{sec:terminal-modal-position-profile,sec:terminal-modal-velocity-profile}.
For velocity, absolute-value summation would discard the required cancellation
between the moving-frontier trace and the boundary pieces.
...
\end{align}
Hence the position and velocity profile inequalities are respectively
equivalent to
\begin{align}
...
The position and velocity sums are bounded in
\cref{sec:terminal-modal-position-profile,sec:terminal-modal-velocity-profile}.
At velocity scale the
