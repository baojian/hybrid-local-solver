...
The remaining regime interface is now static plus one early-position
estimate: prove a uniform bound on $\norm{u_+}_{1,D}/q^3$, and combine it
with a lower bound on the projection-inactive position candidate strong
