...
margin scale.  This reduces the general cyclic target to dynamic aggregate
Schur-diagonal-loss reporting for the energy-packed interval crossings.
...
equitable tree quotient, nor thin radial support, maintain aggregate terminal
Schur-diagonal losses and report all energy-packed finite-band crossings
without refreshing the full boundary, or
...
current pruning scale.  Thus only energy-packed interval crossings need to be
reported.  The remaining obstruction is to maintain aggregate diagonal losses
and locate those crossings without scanning the full boundary inside a large
core with neither bounded articulation blocks, an equitable tree quotient,
nor thin radial support.  Exact trace compression or
