...
or response composition; indeed the graph is supplied for free above.  They
refute only a graph-uniform relative maximum-semantic envelope and the target
product work for the named complete-face full-sweep plain-SOR schedule.  The
