...
\end{equation*}
The same formula holds by continuity at a repeated root, and
...
\begin{corollary}[Finite fixed-face semantic solve]
...
suppose $\|x^\dagger\|_2\leq1$.  Starting from zero, optimal red--black SOR
produces $x^{(k)}$ with
\begin{equation}
