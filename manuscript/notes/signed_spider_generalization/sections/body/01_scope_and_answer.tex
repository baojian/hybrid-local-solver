...
\item \textbf{Proved here: an accuracy and objective bridge.}  RPPR has at
      ...
      right-hand side.
\item \textbf{Proved here: a fixed-face SOR generalization.}  Optimal
      red--black SOR has an exact singular-mode rate on every bipartite
      principal face.  Spider prefixes are an explicit specialization.
...
The graph-uniform objective remains open.  The fixed-face theorem does not
make support discovery free, and the response theorems do not cover arbitrary
