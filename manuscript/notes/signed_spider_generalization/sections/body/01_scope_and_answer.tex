...
This note supplies three layers, and labels them separately.
...
The graph-uniform objective remains open.  Exact nonsettled face-shock
orthogonality closes numerical transport under a supplied geometric volume
gate, but does not make support discovery or boundary reporting free; the
response theorems still do not cover arbitrary large biconnected cores.
