#!/usr/bin/env python3
"""Exact finite-root certificate for the retimed eighteen-leaf extension."""
...
from stopped_masked_input_residual_beta_04894_eighteen_leaf_zero_root_retimed_exact import (
    BETA_04894_EIGHTEEN_LEAF_RETIMED_RHO_SCALE as _ZERO_ROOT_RETIMED_RHO_SCALE,
    BETA_04894_EIGHTEEN_LEAF_RETIMED_STOP_BETA as _ZERO_ROOT_RETIMED_STOP_BETA,
)


BETA_04894_EIGHTEEN_LEAF_RETIMED_ROOT = F(1, 16384)
BETA_04894_EIGHTEEN_LEAF_RETIMED_VERTICES = (
    BETA_04894_EIGHTEEN_LEAF_ZERO_ROOT_VERTICES
)
BETA_04894_EIGHTEEN_LEAF_RETIMED_EDGES = BETA_04894_EIGHTEEN_LEAF_ZERO_ROOT_EDGES
BETA_04894_EIGHTEEN_LEAF_RETIMED_RELATIVE_WIDTH = (
    BETA_04894_EIGHTEEN_LEAF_ZERO_ROOT_RELATIVE_WIDTH
)
BETA_04894_EIGHTEEN_LEAF_RETIMED_RHO_SCALE = (
    _ZERO_ROOT_RETIMED_RHO_SCALE
)
BETA_04894_EIGHTEEN_LEAF_RETIMED_STOP_BETA = (
    _ZERO_ROOT_RETIMED_STOP_BETA
)
...
def main() -> None:
    ...
    result = trace_retained_prox(
        neighbors,
        source=source,
        root=BETA_04894_EIGHTEEN_LEAF_RETIMED_ROOT,
    ...
    alpha = BETA_04894_EIGHTEEN_LEAF_RETIMED_ROOT**2 / (
        2 - BETA_04894_EIGHTEEN_LEAF_RETIMED_ROOT**2
    )
    rho = BETA_04894_EIGHTEEN_LEAF_RETIMED_RHO_SCALE / len(neighbors[source])
    print(
        json.dumps(
            serialize(
                {
