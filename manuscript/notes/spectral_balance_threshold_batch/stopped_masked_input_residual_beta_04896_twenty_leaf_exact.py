#!/usr/bin/env python3
"""Exact finite-root twenty-leaf counterexample at beta=.48935."""
...
from stopped_masked_input_residual_beta_04896_twenty_leaf_zero_root_limit_audit_exact import (
    ...
    BETA_04896_TWENTY_LEAF_ZERO_ROOT_RHO_SCALE,
    BETA_04896_TWENTY_LEAF_ZERO_ROOT_STOP_BETA,
    BETA_04896_TWENTY_LEAF_ZERO_ROOT_VERTICES,
)


BETA_04896_TWENTY_LEAF_VERTICES = BETA_04896_TWENTY_LEAF_ZERO_ROOT_VERTICES
BETA_04896_TWENTY_LEAF_EDGES = BETA_04896_TWENTY_LEAF_ZERO_ROOT_EDGES
BETA_04896_TWENTY_LEAF_ROOT = F(1, 65536)
BETA_04896_TWENTY_LEAF_RHO_SCALE = (
    BETA_04896_TWENTY_LEAF_ZERO_ROOT_RHO_SCALE
)
BETA_04896_TWENTY_LEAF_RELATIVE_WIDTH = (
    BETA_04896_TWENTY_LEAF_ZERO_ROOT_RELATIVE_WIDTH
)
...
def main() -> None:
    neighbors, source = build_graph(
        {
            "vertices": BETA_04896_TWENTY_LEAF_VERTICES,
            "edges": list(BETA_04896_TWENTY_LEAF_EDGES),
            "source": 0,
        },
        None,
    )
    assert (
        len(BETA_04896_TWENTY_LEAF_EDGES)
        == len(set(BETA_04896_TWENTY_LEAF_EDGES))
        == 84
    )
    result = trace_retained_prox(
        neighbors,
        source=source,
        root=BETA_04896_TWENTY_LEAF_ROOT,
        rho_scale=BETA_04896_TWENTY_LEAF_RHO_SCALE,
        relative_width=BETA_04896_TWENTY_LEAF_RELATIVE_WIDTH,
        maximum_phase_products=100,
        maximum_phases=70,
        chronology="one-push-maximal",
        stop_beta=BETA_04896_TWENTY_LEAF_STOP_BETA,
    )
    ...
    assert lower < BETA_04896_TWENTY_LEAF_STOP_BETA < upper
    ...
    alpha = BETA_04896_TWENTY_LEAF_ROOT**2 / (
        2 - BETA_04896_TWENTY_LEAF_ROOT**2
    )
    rho = BETA_04896_TWENTY_LEAF_RHO_SCALE / len(neighbors[source])
    print(
        json.dumps(
            serialize(
                {
                    ...
                    "vertices": BETA_04896_TWENTY_LEAF_VERTICES,
                    "edges": BETA_04896_TWENTY_LEAF_EDGES,
                    "source": source,
                    "root": BETA_04896_TWENTY_LEAF_ROOT,
                    "alpha": alpha,
                    "rho_scale": BETA_04896_TWENTY_LEAF_RHO_SCALE,
                    "rho": rho,
                    "relative_width": BETA_04896_TWENTY_LEAF_RELATIVE_WIDTH,
                    "chosen_stop_beta": BETA_04896_TWENTY_LEAF_STOP_BETA,
