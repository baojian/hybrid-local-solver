#!/usr/bin/env python3
"""Exact full comparison audit for the eighteen-leaf beta-0.48915 limit."""
...
BETA_04894_EIGHTEEN_LEAF_ZERO_ROOT_VERTICES = 45
BETA_04894_EIGHTEEN_LEAF_ZERO_ROOT_EDGES = tuple(
    sorted(set(BETA_04892_SIXTEEN_LEAF_ZERO_ROOT_EDGES) | {(4, 43), (17, 44)})
)
BETA_04894_EIGHTEEN_LEAF_ZERO_ROOT_RHO_SCALE = F(6121, 500000)
BETA_04894_EIGHTEEN_LEAF_ZERO_ROOT_RELATIVE_WIDTH = (
    BETA_04892_SIXTEEN_LEAF_ZERO_ROOT_RELATIVE_WIDTH
)
BETA_04894_EIGHTEEN_LEAF_ZERO_ROOT_STOP_BETA = F(9783, 20000)

EXPECTED_POST_CLOSURE_ZEROS = {
    (1, 1): (2, 18, 30, 33, 37),
    (2, 1): (4,),
    (4, 1): (8, 14, 29, 39, 44),
    (5, 1): (15, 27, 31, 35, 36, 43),
    (7, 1): (11, 24),
    (8, 1): (9,),
    (9, 1): (28,),
    (11, 1): (10,),
...
def main() -> None:
    ...
    assert (
        len(BETA_04894_EIGHTEEN_LEAF_ZERO_ROOT_EDGES)
        == len(set(BETA_04894_EIGHTEEN_LEAF_ZERO_ROOT_EDGES))
        == 82
    )
    result = trace_zero_root_limit(
        neighbors,
        source=source,
        rho_scale=BETA_04894_EIGHTEEN_LEAF_ZERO_ROOT_RHO_SCALE,
        relative_width=BETA_04894_EIGHTEEN_LEAF_ZERO_ROOT_RELATIVE_WIDTH,
        stop_beta=BETA_04894_EIGHTEEN_LEAF_ZERO_ROOT_STOP_BETA,
    )
    ...
    assert lower < BETA_04894_EIGHTEEN_LEAF_ZERO_ROOT_STOP_BETA < upper
    ...
    assert ratio_7 - ratio_3 < F(1, 50000)
            ...
            serialize(
                {
                    ...
                    "chosen_stop_beta": BETA_04894_EIGHTEEN_LEAF_ZERO_ROOT_STOP_BETA,
