#!/usr/bin/env python3
"""Exact finite-root rho-retimed twenty-two-leaf counterexample."""
...
from stopped_masked_input_residual_beta_04898_twenty_two_leaf_zero_root_retimed_exact import (
    BETA_04898_TWENTY_TWO_LEAF_RETIMED_EDGES,
    BETA_04898_TWENTY_TWO_LEAF_RETIMED_RELATIVE_WIDTH,
    BETA_04898_TWENTY_TWO_LEAF_RETIMED_RHO_SCALE,
    BETA_04898_TWENTY_TWO_LEAF_RETIMED_STOP_BETA,
    BETA_04898_TWENTY_TWO_LEAF_RETIMED_VERTICES,
)


BETA_04898_TWENTY_TWO_LEAF_RETIMED_ROOT = F(1, 65536)
...
def main() -> None:
    ...
    result = trace_retained_prox(
        neighbors,
        source=source,
        root=BETA_04898_TWENTY_TWO_LEAF_RETIMED_ROOT,
    ...
    assert F(7, 10000000) < ratio_3 - ratio_7 < F(8, 10000000)

    alpha = BETA_04898_TWENTY_TWO_LEAF_RETIMED_ROOT**2 / (
        2 - BETA_04898_TWENTY_TWO_LEAF_RETIMED_ROOT**2
    )
    assert alpha == F(1, 8589934591)
    rho = BETA_04898_TWENTY_TWO_LEAF_RETIMED_RHO_SCALE / len(
        neighbors[source]
    )
    print(
        json.dumps(
