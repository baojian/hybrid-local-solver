...
\begin{equation}
 \chi_\kappa
 :=\frac{2(\alpha+\kappa)}{1+\alpha+2\kappa}
 =\frac23.
...
\begin{equation}
 \mathcal E_{t+1}
 \le q\mathcal E_t+C\theta\bar\rho\Gamma_t+e_t,
 \qquad
 q=1-c\sqrt\alpha,quad
...
$(1-q)\bar\rho R_t$.  The argument would have to assume that unseen mass is
already small.
