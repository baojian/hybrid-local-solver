...
\end{equation}
where $R$ is the number of certified wave restarts, followed by either a
structural bound on $R$ or an instance-adaptive guarantee that exposes $R$ in
the theorem.  This formulation is compatible with
