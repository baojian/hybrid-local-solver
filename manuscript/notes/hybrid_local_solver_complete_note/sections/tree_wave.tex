 ...
 m_t=pos{
   ...
   +\frac{2}{3(1-\alpha)}
    \left[
      ...
      +\kappa_{\mathrm A}\bigl((1+\beta_{\mathrm A})m_{t-1}-\beta_{\mathrm A} m_{t-2}\bigr)
    \right]
 }.
...
\begin{equation}
 ...
 =\pos{
   \frac13m_{t,k-1}
   +a_\alpha\bigl((1+\beta_{\mathrm A})m_{t-1,k}-\beta_{\mathrm A} m_{t-2,k}\bigr)
 },
 \qquad
