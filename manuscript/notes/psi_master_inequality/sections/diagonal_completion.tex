...
\begin{proof}
Exact rational inversion on each base cycle shows that the only positive
off-diagonal entries of $K^{\mathrm C}$ are the two adjacent entries.  Write
their common value as $c_n>0$ and define the base completion by
\begin{equation*}
...
For a balanced blow-up, part-constant vectors inherit that base block.  On
