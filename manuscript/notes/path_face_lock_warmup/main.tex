...
The graph-uniform first-stage result has now survived the spider junction,
but the full-cone permanent-tail statement has failed even on a star.  The
remaining spider target is therefore reachability-scoped: characterize the
actual center/arm residual created by endpoint-seeded admissions and decide
whether that narrower family avoids the leaf-difference obstruction in
\eqref{eq:star-leaf-mixture}.
