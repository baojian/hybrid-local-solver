...
logarithmic recursive range bounds. A complete supplied near-linear
recurrence is conditional on an explicitly stated positive-weight
preconditioner constructor; that source extension is not assumed proved.
...
split, curvature drop or objective gap. The supplied near-linear work
recurrence in \cref{thm:op3-conditional-supplied-recursion} remains
conditional on the stated weighted constructor. The nested numerical and
spectral stopping interfaces are implemented and exact-audited on supplied
families; no general source constructor is implemented.
