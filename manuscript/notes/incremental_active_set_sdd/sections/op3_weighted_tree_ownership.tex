...
\paragraph{Audit and uncompleted composition.}
...
This supplies the decomposition and ownership part of the proposed
weighted constructor. The charged tree-distance/congestion computation,
corrected corridor-routing load bound, and source/confidence composition
remain to be reconciled. In particular, the owned-load bound alone
does not yet assert a bound on every resulting rooted piece's routed
stretch. The supplied near-linear recurrence remains \statusconditional.
