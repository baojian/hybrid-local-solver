...
work scale.  The unresolved issue is the locality of the AESP burn-in.  The
following research order minimizes logical dependence and empirical risk.
...
\subsection{Priority 6: benchmark implementation}
...
\subsection{A precise claim that should not yet appear in the paper}

The following unconditional statement is not supported by the current proof:
\begin{equation}
    \text{``AESP--LocSOR has }
...
\end{equation}
The manuscript-ready statement is instead
\cref{thm:trajectory-total}, followed by the conditional
\cref{thm:conditional-total} and an explicit description of the missing
locality lemma.  This distinction is central to the scientific credibility of
the project.
