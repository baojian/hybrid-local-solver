...
\(\softO(1/(\sqrt\alpha\eps))\), nor should it require beating the
...
\begin{equation}
   \norm{D_i^{-1}(\widehat\pi_i-\pi_i)}_\infty\leq\eps_i.
...
\(\eps\).  It must include cases where AESP's early acceleration is valuable
