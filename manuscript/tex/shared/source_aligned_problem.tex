...
\(n:=|V|\geq2\) and unit edge weights. Let
\(V=[n]:=\{1,\ldots,n\}\), and let
...
displayed powers of \(D\) are well defined.
...
is the seed vertex. Thus \(s\) is never used as a vertex label.  The
